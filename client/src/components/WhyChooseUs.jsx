import gif from '../../public/assets/tumblr_ltu9giEonl1r5qrimo1_500.gif'

const WhyChooseUs = () => {
    return (
      <div id="why-briefly" style = {{ backgroundColor: '#24243b'}}className="  text-white p-8 flex items-center justify-center">
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 ">
          <div className="text-justify mx-20">
            <h2 className="text-3xl font-bold mb-4 italic">
              Why Choose <span className="text-purple-400">simplify</span>?
            </h2>
